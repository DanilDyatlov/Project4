...
void NaturalNumbersRange(int firstNum, int secondNum)
{
    ...
    else if (firstNum < secondNum) // 12345 если убрать else то будет ошибка так как метод приходит на 15 строчку и сам себя зканчивает 
    {
